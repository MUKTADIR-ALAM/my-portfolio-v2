...
const Contact = () => {
  ...
  return (
    ...
    >
      <div className="w-full h-full bg-black bg-opacity-80 py-20 px-8">
        <div className="max-w-6xl h-full mx-auto flex flex-col gap-6 md:gap-12">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-col items-center gap-3">
              ...
              <p className="text-sm tracking-wide">Mymensing, Bangladesh</p>
            </div>
            <div className="flex flex-col items-center gap-3">
              <FaPhoneAlt className="text-4xl text-designColor" />
              <p className="text-sm tracking-wide">+8801725908830</p>
            </div>
            <div className="flex flex-col items-center gap-3">
              <FaEnvelope className="text-4xl text-designColor" />
              <p className="text-sm tracking-wide">muktdiralam38@gmail.com</p>
            </div>
          </div>
      ...
      <div className="w-full py-10 bg-black flex flex-col md:flex-row px-4 md:items-center justify-between">
        ...
        <a href="https://reactbd.com/" target="_blank">
          <p>© 2025 Muktadir All rights reserved.</p>
        </a>
      </div>
    </section>
  );
